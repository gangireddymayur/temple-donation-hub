...
CREATE TABLE `companies` (
  ...
  `customer_info_config` LONGTEXT DEFAULT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `donations` (
  ...
  `donor_pincode` VARCHAR(32) DEFAULT NULL,
  `donor_gotra` VARCHAR(255) DEFAULT NULL,
  `donor_nakshatra` VARCHAR(255) DEFAULT NULL,
  `special_prayer` TEXT DEFAULT NULL,
