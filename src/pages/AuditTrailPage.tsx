...
export default function SuperAdminAuditTrailPage() {
  ...
  const exportCSV = () => {
    ...
    link.setAttribute("download", `SuperAdmin_Audit_Trail_${new Date().toISOString().slice(0, 10)}.csv`);
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold tracking-tight">Global Audit Trail & Activity Log</h1>
            </div>
            <p className="text-xs text-muted-foreground mt-1">
              Super Admin system-wide audit of user signups, faith configuration switches, layout edits and logins.
            </p>
          </div>
          <div className="flex items-center gap-2">
